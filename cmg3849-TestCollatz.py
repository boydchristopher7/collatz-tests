...
class TestCollatz (TestCase):
    ...
    # will make more tests dependent on larger ranges.
    ...
    def test_print_5(self):
        w = StringIO()
        collatz_print(w, 902, 902, 55)
        self.assertEqual(w.getvalue(), "902 902 55\n")
