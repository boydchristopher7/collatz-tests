...
class TestCollatz (TestCase):
    ...
    def test_print_3(self):
        w = StringIO()
        collatz_print(w, 300, 150, 128)
        self.assertEqual(w.getvalue(), "300 150 128\n")
