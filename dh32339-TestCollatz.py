...
class TestCollatz (TestCase):
    ...
    # Tests reversed numbers

    def test_eval_5(self):
        v = collatz_eval(200, 100, cache)
        self.assertEqual(v, 125)

    # Should return 0 bc No Integers between 2000 and 2000

    def test_eval_6(self):
        v = collatz_eval(2000, 2000, cache)
        self.assertEqual(v, 113)

    def test_eval_7(self):
        v = collatz_eval(532, 2342, cache)
